...
export const SvgComponent = () => {
  ...
  return (
    <svg ref={svgRef}	onMouseMove={e => coords.set(screenToSVG({ x: e.clientX, y: e.clientY }))}
          ...
          <g clip-path="url(#clip0_878_1737)">
              ...
              <g transform='translate({$coords.x} {$coords.y})' style="mix-blend-mode:color-dodge" filter="url(#filter2_f_878_1737)">
